 ...
 * @author g.boone
 */
public class telagerenciarTreinamentos extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(telagerenciarTreinamentos.class.getName());

    /**
     * Creates new form telagerenciarTreinamentos
     */
    public telagerenciarTreinamentos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/syntrex/imagens/gerenciar treinamentos.png"))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NOME", "FUNÇÃO", "TREINAMENTO ", "STATUS"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new telagerenciarTreinamentos().setVisible(true));
    }
